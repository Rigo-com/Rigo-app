...
function createServiceStateSnapshot(){
  return Object.freeze({
    ...
    synchronized:serviceState.synchronized,
    booted:serviceState.booted,
    startedAt:serviceState.startedAt,
    stoppedAt:serviceState.stoppedAt,

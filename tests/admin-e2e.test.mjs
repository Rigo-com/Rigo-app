...
const snapshot=Admin.snapshot();assert.equal(snapshot.state.running,true);assert.equal(snapshot.registry.modules.length,3);assert.equal(await Admin.shutdown(),true);console.log("ADMIN_E2E_DONE");console.log("Admin end-to-end runtime test passed");
